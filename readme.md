...
- [Firebase Genkit](https://github.com/xavidop/awesome-firebase-genkit#readme) - [Genkit](https://firebase.google.com/docs/genkit) is an open-source Framework for building AI-powered apps and features.
